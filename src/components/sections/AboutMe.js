    ...
    <Fragment>
      <div className="content about">
        ...
        <div className="row">
          ...
          <div className="col col-d-12 col-t-6 col-m-12 border-line-v">
            <p>
              <span className="first-letter"> A</span>s a developer, I enjoy
            ...
            <p>
              <span className="first-letter">I</span> love being able to help
              people by simplifying some of life&apos;s more complex problems.
            </p>
          </div>
